...
- [x] 实现 watermark 扫描与组织范围提取（AC: 1）
  ...
  - [x] 组织范围提取遵循 [graph-sync-operating-model.md](/Users/delldi/work-code/open-code/ontology-agent/docs/data-contracts/graph-sync-operating-model.md) 中定义的 source 规则，特别是：
