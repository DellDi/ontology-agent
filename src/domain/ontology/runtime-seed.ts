...
export function buildRuntimeMetricSeeds(
  ...
  return [
    ...
    {
      ...base,
      id: `metric-service-order-count-${versionId}`,
      businessKey: 'service-order-count',
      displayName: '工单总量',
      description: '按项目和时间范围统计服务工单数量，作为服务压力和服务效率分析的基础指标。',
      applicableSubjectKeys: ['project'],
      defaultAggregation: 'count',
      unit: '单',
      metadata: { intentTypes: ['work-order-analysis', 'fee-analysis'], sourceFact: '工单主题' },
    },
    {
      ...base,
      id: `metric-complaint-count-${versionId}`,
      businessKey: 'complaint-count',
      displayName: '投诉量',
      description: '按项目和时间范围统计投诉类工单数量，用于识别服务体验风险。',
      applicableSubjectKeys: ['project'],
      defaultAggregation: 'count',
      unit: '单',
      metadata: { intentTypes: ['work-order-analysis', 'fee-analysis'], sourceFact: '工单主题（投诉子集）' },
    },
    {
      ...base,
      id: `metric-average-satisfaction-${versionId}`,
      businessKey: 'average-satisfaction',
      displayName: '平均满意度',
      description: '按已完成工单的有效满意度评分计算平均值，用于衡量业主服务体验。',
      applicableSubjectKeys: ['project'],
      defaultAggregation: 'avg',
      unit: '分',
      metadata: { intentTypes: ['work-order-analysis', 'fee-analysis'], sourceFact: '工单主题（满意度派生）' },
    },
    {
      ...base,
      id: `metric-average-response-duration-hours-${versionId}`,
      businessKey: 'average-response-duration-hours',
      displayName: '平均响应时长',
      description: '工单从创建到首次响应的平均时长（小时），用于衡量响应效率。',
      applicableSubjectKeys: ['project'],
      defaultAggregation: 'avg',
      unit: '小时',
      metadata: { intentTypes: ['work-order-analysis', 'fee-analysis'], sourceFact: '工单主题' },
    ...
    {
      ...base,
      id: `metric-average-close-duration-hours-${versionId}`,
      businessKey: 'average-close-duration-hours',
      displayName: '平均关闭时长',
      description: '工单从创建到完成的平均时长（小时），用于衡量闭环处理效率。',
      applicableSubjectKeys: ['project'],
      defaultAggregation: 'avg',
      unit: '小时',
      metadata: { intentTypes: ['work-order-analysis', 'fee-analysis'], sourceFact: '工单主题' },
...
export function buildRuntimePlanStepTemplateSeeds(
  ...
  return [
    ...
    },
    {
      ...
      requiredCapabilities: ['semantic-query', 'graph-query', 'erp-read'],
      sortOrder: 3,
      metadata: { primaryTools: ['cube.semantic-query', 'neo4j.graph-query', 'erp.read-model'] },
    },
    {
      ...base,
