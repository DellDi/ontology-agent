...
ALTER TABLE "platform"."analysis_execution_snapshots" ADD COLUMN "ontology_version_source" text DEFAULT 'legacy-unknown' NOT NULL;--> statement-breakpoint
ALTER TABLE "platform"."analysis_session_follow_ups" ADD COLUMN "ontology_version_id" text;--> statement-breakpoint
ALTER TABLE "platform"."analysis_session_follow_ups" ADD COLUMN "ontology_version_source" text DEFAULT 'legacy-unknown' NOT NULL;--> statement-breakpoint
